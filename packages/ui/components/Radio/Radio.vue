...
<template>
    <label :class="['inline-flex align-middle', disabled && 'opacity-60 pointer-events-none']">
        <input
            type="radio"
            :class="[
                'focus:outline-none appearance-none transition-colors inline-block align-middle bg-origin-border select-none shrink-0 w-5 h-5 text-primary-500 rounded-full shadow-sm border border-secondary-300',
